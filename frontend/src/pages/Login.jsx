        ...
        <div className="flex h-[calc(100vh-140px)] items-center justify-center">
            <div className="w-full max-w-md space-y-8 bg-white/70 dark:bg-zinc-900/70 backdrop-blur-xl p-10 rounded-[2rem] shadow-2xl border border-white/40 dark:border-zinc-800/50">
                <div className="flex flex-col items-center">
                    <div className="bg-gradient-to-br from-blue-600 to-indigo-600 p-3 rounded-2xl shadow-lg shadow-indigo-500/30 mb-4">
                        <Wallet className="w-8 h-8 text-white" />
                    </div>
                    <h2 className="mt-2 text-center text-3xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-indigo-700 dark:from-blue-400 dark:to-indigo-400">
                        Welcome Back
                    </h2>
                ...
                <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
                    ...
                    <div className="space-y-4">
                        <div className="relative group">
                            ...
                            <input
                                ...
                                autoComplete="email"
                                required
                                className="block w-full rounded-xl border border-gray-200 bg-white/50 py-3.5 pl-11 pr-4 text-gray-900 shadow-sm placeholder:text-gray-400 focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 sm:text-sm sm:leading-6 dark:bg-zinc-800/50 dark:border-zinc-700 dark:text-white dark:focus:bg-zinc-800 dark:focus:border-indigo-500 dark:focus:ring-indigo-500/20 transition-all duration-200 ease-in-out outline-none"
                    ...
                    <div>
                        <button
                            type="submit"
                            disabled={loading}
                            className="group relative flex w-full justify-center items-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 py-3.5 px-3 text-sm font-semibold text-white shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50 hover:from-blue-500 hover:to-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:opacity-70 disabled:cursor-not-allowed transform transition-all duration-200 hover:-translate-y-0.5"
                        >
                            {loading ? (
                                "Signing in..."
                            ) : (
